...
const Work = () => (
  <Layout title="Social-Monitoring">
    <Container mt={50}>
      ...
      <P>
        During COVID, colleges went online. It was a sudden change and the shift
        to  making things accessible online wasn't easy. Students weren't able
        to host any hackathons, nor teachers were able to assess tech
        assignments properly. I came up with the idea to host a tech blogging
        website that would solve both of these issues.
        <br />
        <br />
      ...
      <P>
        We received feedback that users didn't like that they couldn't view
        certain pages or do certain actions until they were logged in. This
        prompted a critical realization: We had built the website like an
        engineer, and not a user.
        <br />
        <br />
      ...
      <P>
        Some use cases can demand a structural overhaul in the entire project,
        so we should always build components as loosely coupled as possible, so
        ...
        that showed me the power of the open-source community and encouraged me
        to contribute back into the community as well!
      </P>
    </Container>
  </Layout>
)
